...
<head>
    ...
    <title>{{ config('app.name', '莘莘') }}</title>
    ...
    <!-- Date Picker -->
    <link rel="stylesheet"
          href="/AdminLTE-2.4.5/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <!-- Daterange picker -->
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- Main content -->
        <section content="content" id="app">
            @yield('content')
...
<!-- jQuery Knob Chart -->
<script src="/AdminLTE-2.4.5/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
...
<!-- datepicker -->
<script src="/AdminLTE-2.4.5/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
