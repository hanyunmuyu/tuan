                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img :src="$store.state.user.avatar" class="user-image" alt="User Image">
                                <span class="hidden-xs">{{$store.state.user.name}}</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img :src="$store.state.user.avatar" class="img-circle" alt="User Image">

                                    <p>
                                        {{$store.state.user.name}}
                                        <small>最近登录 {{$store.state.user.updated_at}}</small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                <!-- Menu Footer-->
            ...
            <section class="sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li>
                                <router-link :to="{path:'/school'}"><i class="fa fa-circle-o"></i>高校列表</router-link>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li>
                                <router-link :to="{path:'/community'}"><i class="fa fa-circle-o"></i>社团列表</router-link>
                            </li>
                        </ul>
                    </li>
                    <li>
